  ...
  return initial.isPublished ? (
    <div className='space-y-3'>
      ...
      <div className='flex items-center'>
        ...
        />
        <Button size='sm' onClick={handleCopyUrl} disabled={copied} className='h-8 rounded-l-none'>
          {copied ? (
    ...
    <div className='flex flex-col items-center justify-center'>
      ...
      <span className='mb-4 text-xs text-muted-foreground'>Share your notes with the world</span>
      <Button
